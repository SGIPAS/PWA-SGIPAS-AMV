// ocp Informe de Gestión Operacional – checklist de parámetros con fechas independientes
import { supabase } from '../../supabase-client.js';
import { exportarAExcel } from './utils.js';

let checklistEstado = {}; // guarda { id: { marcado, desde, hasta, selectorValor } }
    ...
    document.querySelectorAll('.check-param').forEach(chk => {
        ...
        chk.addEventListener('change', function() {
            ...
            if (this.checked) {
                ...
                // Si no tiene fechas, poner últimos 7 días por defecto
...
async function generarInforme(grupos) {
    const seleccionados = [];
    // Recorrer todos los items de los grupos
    grupos.forEach(grupo => {
        grupo.items.forEach(item => {
